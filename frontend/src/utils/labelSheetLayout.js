...
export const REAL_LABEL_SIZES = {
  small: { width: 220, height: 100 },
  medium: { width: 300, height: 140 },
  large: { width: 400, height: 190 },
};

// רוחב עמוד A4 לשימוש (כ-190 מ"מ שטח הדפסה בפועל, בהתחשב בשוליים)
export const REAL_PAGE_CONTENT_WIDTH = 718;
export const REAL_GAP_PX = 16;
...
export function getRealColumns(sizeKey) {
  const size = REAL_LABEL_SIZES[sizeKey] || REAL_LABEL_SIZES.medium;
